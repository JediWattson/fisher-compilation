# Fisher Graph Transformer — Research Log

> Historical experiment chronology, command catalog, and implementation
> walkthrough. Start with the concise [current research overview](README.md).
