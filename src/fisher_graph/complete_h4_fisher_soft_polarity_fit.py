"""Pure V20f soft-polarity development fitting protocol.
...
_PROTOCOL_DOMAIN = b"fisher-graph:complete-h4-soft-polarity-fit:protocol:v20f\0"
_DIRECTION_DOMAIN = b"fisher-graph:complete-h4-soft-polarity-fit:direction:v20f\0"
_CANDIDATE_DOMAIN = b"fisher-graph:complete-h4-soft-polarity-fit:candidate:v20f\0"
_FOLD_DOMAIN = b"fisher-graph:complete-h4-soft-polarity-fit:fold:v20f\0"
_OOF_DOMAIN = b"fisher-graph:complete-h4-soft-polarity-fit:oof:v20f\0"
_GRADIENT_DOMAIN = b"fisher-graph:complete-h4-soft-polarity-fit:gradient:v20f\0"
_OBJECTIVE_DOMAIN = b"fisher-graph:complete-h4-soft-polarity-fit:objective:v20f\0"
...
_PROTOCOL = {
    "protocol": "v20f_continuous_soft_polarity_natural_fit",
...
def _direction_payload_from_summaries(
    *,
    ...
    direction = _solve_spd(damped, tuple(-item for item in mean_gradient))
    derivative = math.fsum(mean_gradient[i] * direction[i] for i in range(4))
    ...
    return {
        ...
        "finite": all(math.isfinite(item) for item in direction),
        "strict_descent": derivative < 0.0 and norm > 0.0,
...
def build_soft_polarity_direction_receipt(
    *,
    ...
    result = _finish("fisher_graph.complete_h4_soft_polarity_direction.v20f", _DIRECTION_DOMAIN, payload)
...
def validate_soft_polarity_direction_receipt(value: Mapping[str, object]) -> None:
    ...
    if receipt.get("schema") != "fisher_graph.complete_h4_soft_polarity_direction.v20f" or receipt.get("protocol_sha256") != SOFT_POLARITY_FIT_PROTOCOL_SHA256 or _canonical({key: receipt.get(key) for key in expected}) != _canonical(expected):
...
def build_soft_polarity_candidate_receipt(
    *,
    ...
    result = _finish("fisher_graph.complete_h4_soft_polarity_candidate.v20f", _CANDIDATE_DOMAIN, payload)
...
def validate_soft_polarity_candidate_receipt(value: Mapping[str, object], *, direction_receipt: Mapping[str, object]) -> None:
    ...
    expected_pairs = {
        "schema": "fisher_graph.complete_h4_soft_polarity_candidate.v20f",
        "protocol_sha256": SOFT_POLARITY_FIT_PROTOCOL_SHA256,
        "direction_artifact_sha256": direction_receipt["artifact_sha256"],
        "held_family_id": direction_receipt["held_family_id"],
        "training_family_ids": training,
...
def build_soft_polarity_fold_receipt(
    *,
    ...
    result = _finish("fisher_graph.complete_h4_soft_polarity_fold.v20f", _FOLD_DOMAIN, payload)
...
def validate_soft_polarity_fold_receipt(value: Mapping[str, object], *, direction_receipt: Mapping[str, object], candidate_receipts: Sequence[Mapping[str, object]]) -> None:
    ...
    expected = {
        "schema": "fisher_graph.complete_h4_soft_polarity_fold.v20f",
        "protocol_sha256": SOFT_POLARITY_FIT_PROTOCOL_SHA256,
        "source_artifact_sha256s": direction_receipt["source_artifact_sha256s"],
        "all_development_family_ids": direction_receipt["all_development_family_ids"],
        "held_family_id": direction_receipt["held_family_id"],
...
def _authenticated_oof_fold_lineage(
    ...
    *,
    ...
    for fold in folds:
        ...
        if (
            fold.get("schema")
            != "fisher_graph.complete_h4_soft_polarity_fold.v20f"
...
def build_soft_polarity_oof_qualification(*, fold_receipts: Sequence[Mapping[str, object]]) -> dict[str, object]:
    ...
    result = _finish("fisher_graph.complete_h4_soft_polarity_oof.v20f", _OOF_DOMAIN, payload)
...
def validate_soft_polarity_oof_qualification(value: Mapping[str, object], *, fold_receipts: Sequence[Mapping[str, object]]) -> None:
    ...
    authorized = all(gates.values())
    expected = {
        "schema": "fisher_graph.complete_h4_soft_polarity_oof.v20f",
        "protocol_sha256": SOFT_POLARITY_FIT_PROTOCOL_SHA256,
        "source_artifact_sha256s_by_family": sources_by_family,
        "development_family_ids": families,
...
def soft_polarity_work_accounting(
    *,
    ...
    return {
        "schema": "fisher_graph.complete_h4_soft_polarity_work.v20f",
        "development_family_count": 8,
        "outer_fold_count": 8,
